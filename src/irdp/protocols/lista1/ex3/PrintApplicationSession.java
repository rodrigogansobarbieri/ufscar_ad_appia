...
public class PrintApplicationSession extends Session {
  ...
  public void handle(Event event) {
    ...
    if (event instanceof ChannelInit)
      ...
      handlePrintConfirm((JobConfirmEvent) event);
  ...
  private void handlePrintConfirm(JobConfirmEvent conf) {
    System.out.println("[PrintApplication: received confirmation of job request "
        + conf.getId() + "]");
    ...
    public void run() {
      ...
      while (running) {
        ...
        try {
          ...
          JobSubmitEvent request = new JobSubmitEvent();
          request.setId(rid);
          request.setString(s);
