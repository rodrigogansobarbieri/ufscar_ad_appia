...
public class ApplSession extends Session {
	...
	public void handle(Event event) {
		...
		else if (event instanceof LeaderTrustEvent)
			handleLeaderTrustEvent((LeaderTrustEvent) event);
	}

	private void handleLeaderTrustEvent(LeaderTrustEvent event) {
		System.out.println("New Leader is: " + event.getLeaderName());
